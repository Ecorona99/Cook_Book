...
import pandas as pd
import re
from Graph_Crafting import calculate_PMI_neighbors
from Data_Processing import get_recipe_id
...
input_label = ttk.Label(input_frame, width = 20, text = "Receta a buscar:", font = "Calibri 20 bold", anchor = tk.CENTER)
